...
![Violin vs Boxplot Comparison](../Draft/boxplot_violin_comparison.png)
...
![Bandwidth Comparison](../Draft/london_bandwidth_comparison.png)
...
![Violin with Boxplot Overlay](../Draft/violin_box_bike_styled.png)
...
![Boxplot vs Violin Comparison](../Draft/two_datasets_comparison.png)
...
![Orientation Examples](../Draft/skewed_data_plots_vertical.png)
...
![Violin with Boxplot Overlay](../Draft/delivery_violin_grouped_box.png)
...
![Violin with Beeswarm](../Draft/bike_violin_strip_swarm_subset.png)
...
![Violin with Rug](../Draft/bike_violin_rug_per_city_fixed.png)

### 4.3 Grouped vs split violins

![Grouped and Split Violins](../Draft/delivery_grouped_split_violin.png)
...
![Raincloud Plot](../Draft/raincloud_4cities_overlap.png)
