...
df = pd.read_csv("synthetic_scatter_master_dataset.csv")
...
# Save the plot
plt.savefig("figure_1_bubble_scatter.png", dpi=220, facecolor="white")
plt.close()
print("Saved: figure_1_bubble_scatter.png")